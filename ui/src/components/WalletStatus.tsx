...
// import { transferAdminCap } from "../utility/helpers/transfer_admin_cap"; // Removed - utility folder deleted
...
export function WalletStatus() {
  ...
  const handleTransferAdmin = () => {
    // Admin transfer functionality removed - not needed for quiz platform
    alert("Admin transfer functionality not available in quiz platform");
  };
